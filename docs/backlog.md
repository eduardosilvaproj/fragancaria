...
| C15 | **Layout da tela Novo Produto desproporcional** — coluna estreita à esquerda e vazio grande à direita; revisar grid/spacing do formulário. | pendente | `src/routes/admin/produtos/novo.tsx` |
