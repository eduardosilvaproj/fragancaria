      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto px-4 md:px-12 max-w-4xl">
          <h1 className="font-serif text-4xl md:text-5xl mb-12 font-light text-[#1A1A1A]">
            Termos e <span className="italic text-[#D4AF37]">Condições</span>
          </h1>
          ...
          <div className="prose prose-lg max-w-none text-[#1A1A1A]/70">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">1. Aceitação dos Termos</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">2. Produtos e Preços</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">3. Pagamento</h2>
              <p className="text-sm leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">4. Entrega</h2>
              <p className="text-sm leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">5. Propriedade Intelectual</h2>
              <p className="text-sm leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">6. Limitação de Responsabilidade</h2>
              <p className="text-sm leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">7. Alterações nos Termos</h2>
              <p className="text-sm leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">8. Contato</h2>
              <p className="text-sm leading-relaxed">
