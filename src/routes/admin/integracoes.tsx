      ...
      <div className="bg-white border border-[#E9E1D2] p-6 mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-4 items-end">
          ...
          <div>
            ...
            <input type="text" className="w-full bg-[#F5F3EE] rounded-lg p-2.5 text-sm outline-none" value={form.label} onChange={(e) => setForm({...form, label: e.target.value})} placeholder="ex: Instagram Loja" />
          </div>
          <div>
