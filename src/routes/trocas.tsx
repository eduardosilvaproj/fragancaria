      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto px-4 md:px-12 max-w-4xl">
          <h1 className="font-serif text-4xl md:text-5xl mb-12 font-light text-[#1A1A1A]">
            Trocas e <span className="italic text-[#D4AF37]">Devoluções</span>
          </h1>
          ...
          <div className="prose prose-lg max-w-none text-[#1A1A1A]/70">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">Direito de Arrependimento</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">Condições para Troca ou Devolução</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">Produtos com Defeito</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">Produtos Não Elegíveis</h2>
              <p className="text-sm leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">Como Solicitar</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">Frete de Devolução</h2>
              <ul className="list-disc pl-6 space-y-2 text-sm">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">Prazo de Reembolso</h2>
              <p className="text-sm leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">Dúvidas</h2>
              <p className="text-sm leading-relaxed">
