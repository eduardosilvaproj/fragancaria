...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Login | Fragranciaria" },
      { name: "description", content: "Acesse sua conta na Fragranciaria." },
    ],
  }),
  component: LoginPage,
});
      ...
      <main className="py-16 md:py-24 px-6 md:px-14">
        <div className="max-w-[440px] mx-auto">
          ...
          <div className="bg-white border border-[#E9E1D2] p-6 md:p-10">
            {/* Google Login Button - DESABILITADO: Servico Google nao configurado no Supabase */}
            <button
              type="button"
              disabled
              className="w-full flex items-center justify-center gap-3 bg-gray-100 border border-[#E0D8C7] text-gray-400 py-3.5 px-4 text-[14px] font-medium cursor-not-allowed mb-6"
            >
          ...
          <p className="text-center text-[13px] text-[#75827E] mt-6">
            Ainda não tem conta?{" "}
            <Link to="/cadastro" className="text-[#B07B1E] hover:underline">
