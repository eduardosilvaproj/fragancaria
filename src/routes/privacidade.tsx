    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-32 pb-24">
        <div className="container mx-auto px-4 md:px-12 max-w-4xl">
          <h1 className="font-serif text-4xl md:text-5xl mb-12 font-light text-[#1A1A1A]">
          ...
          <div className="prose prose-lg max-w-none text-[#1A1A1A]/70">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">1. Dados que Coletamos</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">2. Finalidade do Tratamento</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">3. Base Legal (LGPD)</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">4. Compartilhamento de Dados</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">5. Seus Direitos (LGPD)</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">6. Cookies</h2>
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">7. Segurança</h2>
              <p className="text-sm leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">8. Retenção de Dados</h2>
              <p className="text-sm leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">9. Contato do Encarregado (DPO)</h2>
              <p className="text-sm leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="font-serif text-2xl text-[#1A1A1A] mb-4">10. Alterações</h2>
              <p className="text-sm leading-relaxed">
