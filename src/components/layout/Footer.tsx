        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-8">
              <Instagram className="h-5 w-5 text-[#1C1C1A]/40 hover:text-[#B8955A] cursor-pointer transition-colors" />
              <Facebook className="h-5 w-5 text-[#1C1C1A]/40 hover:text-[#B8955A] cursor-pointer transition-colors" />
              <Youtube className="h-5 w-5 text-[#1C1C1A]/40 hover:text-[#B8955A] cursor-pointer transition-colors" />
            </div>
          </div>
