    ...
    try {
      ...
      const res: any = await createPaymentFn({
        data: {
          ...
          couponCode,
          utmSource: JSON.parse(localStorage.getItem('fragranciaria_utm') || '{}').utm_source,
          utmMedium: JSON.parse(localStorage.getItem('fragranciaria_utm') || '{}').utm_medium,
          utmCampaign: JSON.parse(localStorage.getItem('fragranciaria_utm') || '{}').utm_campaign,
          utmContent: JSON.parse(localStorage.getItem('fragranciaria_utm') || '{}').utm_content,
          utmTerm: JSON.parse(localStorage.getItem('fragranciaria_utm') || '{}').utm_term,
          userId: user?.id,
